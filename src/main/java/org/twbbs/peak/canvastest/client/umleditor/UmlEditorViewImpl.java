...
public class UmlEditorViewImpl implements UmlEditorView{
    ...
    public PushButton getBtnSelection() {
        return btnSelection;
    }
    public PushButton getBtnNewButton() {
        return btnNewButton;
    }
    public PushButton getBtnCompostion() {
        return btnCompostion;
    }
    public PushButton getBtnGerenalization() {
        return btnGerenalization;
    }
    public PushButton getBtnClass() {
        return btnClass;
    }
    public PushButton getBtnUsecase() {
        return btnUsecase;
    }
    public MenuItem getMntmChangeObjectName() {
        return mntmChangeObjectName;
    }
    public MenuItem getMntmGroup() {
        return mntmGroup;
    }
    public MenuItem getMntmUngroup() {
        return mntmUngroup;
    }
}
