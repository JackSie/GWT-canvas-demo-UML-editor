...
public class HelloWorldE implements EntryPoint {
	...
	public void onModuleLoad() {
		...
		bufferedCanvas.setCoordinateSpaceWidth(1024);
		canvas.setCoordinateSpaceHeight(768);
		bufferedCanvas.setCoordinateSpaceHeight(768);
		
		RootPanel.get().add(canvas);
		context=canvas.getContext2d();
		bufferedContext=bufferedCanvas.getContext2d();
